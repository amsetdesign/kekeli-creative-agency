...
import { LayoutDashboard, FolderOpen, Settings, LogOut, ExternalLink, Sparkles, Mic2, BrainCircuit, BarChart2, Award, BookOpen, Briefcase } from "lucide-react";
...
export default function ClientSidebar({ displayName, displayCompany, hasArtistProfile = false, logoutAction }: Props) {
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl font-body text-sm transition-colors ${
                active
                  ...
                  : gold
                    ? "text-[#C8A84B]/80 hover:bg-[#C8A84B]/10 hover:text-[#C8A84B]"
                    : purple
                      ? "text-[#C084FC]/70 hover:bg-[#8B5CF6]/15 hover:text-[#C084FC]"
                      : vision
                        ? "text-[#A78BFA]/80 hover:bg-[#8B5CF6]/10 hover:text-[#C084FC]"
