...
export const metadata: Metadata = {
  title: "Image Digitale — Bio, Photo & Profils Réseaux pour Personnalités",
  description: "Optimisez votre présence en ligne : bio réseaux professionnelle, shooting photo officiel, profils harmonisés et site web personnel — KEKELI Creative Agency, Dakar.",
  alternates: { canonical: "/personnalites/image-digitale" },
};
...
const services = [
  {
    emoji: "🔍", title: "Audit de votre image actuelle",
    desc: "Analyse complète de tous vos profils existants — ce qui fonctionne, ce qui nuit à votre image, ce qu'il faut corriger en priorité.",
    includes: ["Audit Instagram, LinkedIn, Facebook, YouTube", "Score de cohérence visuelle", "Liste des points à corriger", "Recommandations priorisées"],
  },
  {
    emoji: "✍️", title: "Bio & Biographies Optimisées",
    desc: "Des bios courtes et longues rédigées pour convertir : accroche percutante, mots-clés, appels à l'action — en français et en anglais.",
    includes: ["Bio courte (150 car.) pour Instagram", "Bio LinkedIn complète et optimisée", "Biographie longue (site web)", "Version FR & EN disponibles"],
  },
  {
    emoji: "📸", title: "Shooting Photo Professionnel",
    desc: "Des portraits de qualité éditoriale qui reflètent votre personnalité et imposent le respect dès la première image.",
    includes: ["Session shooting en studio ou extérieur", "Retouche professionnelle", "Plusieurs tenues & décors", "Livraison 10 à 20 photos HD"],
  },
  {
    emoji: "🌐", title: "Site Web / Landing Page Personnelle",
    desc: "Une page de présentation professionnelle qui centralise votre bio, vos services, vos réalisations et votre contact.",
    includes: ["Design sur mesure à votre image", "Bio, services, témoignages, contact", "Optimisé SEO & mobile", "Livraison en 10 jours ouvrables"],
  },
];

export default function ImageDigitalePage() {
  return (
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn direction="down" className="mb-8">
            <nav className="flex items-center gap-2 text-xs font-body" style={{ color: "rgba(255,255,255,0.45)" }}>
              ...
              <ChevronRight size={12} />
              <span style={{ color: "rgba(255,255,255,0.70)" }}>Image Digitale</span>
            </nav>
          </FadeIn>
          <div className="max-w-3xl">
            ...
            <FadeIn direction="up" delay={0.22}>
              <p className="font-body text-lg leading-relaxed mb-8 max-w-xl" style={{ color: "rgba(255,255,255,0.65)" }}>
                Bio optimisée, photo officielle, profils réseaux harmonisés et site personnel — chaque détail de votre présence en ligne
                reflète la personne que vous êtes vraiment.
              </p>
            </FadeIn>
      ...
      <section className="py-24" style={{ background: "linear-gradient(160deg, #F0FDF4 0%, #ECFDF5 50%, #F0FDF4 100%)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn direction="up" className="text-center mb-14">
            <p className="font-body text-xs font-semibold uppercase tracking-[0.2em] mb-3" style={{ color: "#059669" }}>Ce qu&apos;on fait pour vous</p>
            <h2 className="font-display text-4xl text-gray-900">Votre image <em className="not-italic" style={{ color: ACCENT }}>partout, cohérente</em></h2>
          </FadeIn>
      ...
      <section id="formulaire" className="py-24 relative overflow-hidden" style={{ background: "#080D0B" }}>
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn direction="up" className="text-center mb-10">
            ...
            <h2 className="font-display text-4xl text-white mb-4">Soignons votre <em className="not-italic" style={{ color: ACCENT }}>image en ligne</em></h2>
