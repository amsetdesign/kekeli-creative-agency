...
const GOLD    = "#C8A84B";   // brand, valeur, CTAs
const VIOLET  = "#8B5CF6";   // segment artiste
const VIOLET2 = "#A78BFA";   // artiste — accent secondaire
const BLUE    = "#1E40AF";   // segment entreprise
const SKY     = "#0EA5E9";   // entreprise — accent secondaire
const EMERALD = "#10B981";   // accompagnement, care, succès
const DARK    = "#0C0B09";
...
type Pack = {
  name: string;
  price: string;          // ex. "75 000 – 200 000"
  unit?: string;          // ex. "/ mois"
  popular?: boolean;
  items: string[];
  color: string;
...
function PackCard({ pack }: { pack: Pack }) {
  return (
    ...
    >
      ...
      <div className="mb-4">
        <span className="font-body font-bold text-2xl" style={{ color: pack.color }}>
          {pack.price}
        </span>
      ...
      <section className="relative py-28 overflow-hidden" style={{ background: DARK }}>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeIn direction="up" delay={0.05}>
            <span
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-6 font-body text-xs font-semibold uppercase tracking-[0.14em]"
          ...
          <FadeIn direction="up" delay={0.12}>
            <h1 className="font-body font-bold text-5xl sm:text-6xl text-white leading-[1.08] mb-5">
              Des tarifs{" "}
              <span style={{ color: GOLD }}>transparents</span>
              <br />adaptés au marché africain
            </h1>
          </FadeIn>
          ...
          <FadeIn direction="up" delay={0.28}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <a
                href={waLink("Bonjour KEKELI 👋 Je voudrais obtenir un devis personnalisé pour un projet. Pouvez-vous me contacter ?")}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <Link
                href="/sondage"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full font-body font-semibold text-sm transition-all"
          ...
          {cats.map(({ id, icon: CatIcon, label, packs }) => (
            <div key={id}>
              ...
              <FadeIn direction="up" className="flex items-center gap-3 mb-7">
                ...
                <span
                  className="ml-auto px-3 py-1 rounded-full font-body text-[11px] font-semibold"
        ...
        <div className="max-w-3xl mx-auto px-4 text-center">
          <p className="font-body text-sm text-[#78716C] leading-relaxed">
            * Les tarifs affichés sont des <strong>fourchettes indicatives</strong> basées sur nos projets habituels.
            Le devis final dépend du périmètre exact, des délais et des spécificités de votre projet.
            <br />
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-4 text-center">
          <FadeIn direction="up">
            ...
            <h2 className="font-display text-4xl md:text-5xl text-white leading-tight mb-4">
              Devis gratuit{" "}
              <em className="not-italic" style={{ color: GOLD }}>sous 24h</em>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href={waLink("Bonjour KEKELI 👋 Je voudrais discuter d'un projet et obtenir un devis. Pouvez-vous me contacter ?")}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <Link
                href="/brief"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-body font-semibold text-base transition-all"
